//Vincent Banks
//Threestrings bot JoinCommand class
...
public class JoinCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        if (checkVoiceState.inVoiceChannel()){ //if bot is in voicechannel this if statement runs
            channel.sendMessage("Hey im already in a voice channel!").queue(); //bot tells server that they are already in a voice channel
            return;
        }
