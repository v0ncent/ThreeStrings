...
public class GuildMusicManager {
    ...
    public final TrackScheduler scheduler; //create new variable without Track scheduler class
    ...
    public GuildMusicManager(AudioPlayerManager manager){ //create audio manager constructor that creates or audio manager
        ...
        this.sendHandler = new AudioPlayerSendHandler(this.audioPlayer); //create a new send handler class with the args of the audio player
    }
